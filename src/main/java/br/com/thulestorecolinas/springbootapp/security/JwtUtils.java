package br.com.thulestorecolinas.springbootapp.security;
...
import br.com.thulestorecolinas.springbootapp.controller.UsuarioDTO;
...
public class JwtUtils {
    ...
    public static String generateToken(Authentication  usuario)  
        ...
        return Jwts.builder().claim("userDetails", usuarioJson)
            .setIssuer("br.com.thulestorecolinas")
